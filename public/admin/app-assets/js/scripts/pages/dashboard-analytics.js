...
$(window).on("load", function () {
    ...
    //         ],
    //         series: [
    //             [20, 180, 125, 40, 80, 50, 20, 180, 125, 40, 80, 50],
    ...
    var analyticsDonutChart = new Chartist.Pie(
    ...
    var projectIncomeBar = new Chartist.Bar(
        "#project-income-chart",
        {
            labels: ["2017", "2016", "2015", "2014", "2013", "2012"],
            series: [[8000, 12000, 14000, 13000, 9000, 7000]],
        },
        {
            axisY: {
                labelInterpolationFnc: function (value) {
    ...
    var newProjects = new Chartist.Line(
        "#new-projects",
        {
