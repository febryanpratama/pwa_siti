                                    ...
                                    <div class="carousel slide pt-1" id="carousel-example" data-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active"><img class="d-block w-100"
                                                    src="{{ asset('') }}admin/app-assets/images/carousel/08.jpg"
                                                    alt="First slide"></div>
                                            <div class="carousel-item"><img class="d-block w-100"
                                                    src="{{ asset('') }}admin/app-assets/images/carousel/03.jpg"
                                                    alt="Second slide"></div>
                                            <div class="carousel-item"><img class="d-block w-100"
                                                    src="{{ asset('') }}admin/app-assets/images/carousel/01.jpg"
                                                    alt="Third slide"></div>
                                ...
                                <div class="arrow_box_right">
                                    ...
                                    <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                            ...
                                            <div class="media">
                                                <div class="media-left"><span
                                                        class="avatar avatar-sm rounded-circle"><img
                                                            src="{{ asset('') }}admin/app-assets/images/portrait/small/avatar-s-3.png"
                                                            alt="avatar"></span></div>
                                                <div class="media-body">
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        for (let index = 0; index < listData.length; index++) {
                            ...
                            $("select#dataset").append('<option value="'+listData[index].id+'">'+listData[index].semester+', '+listData[index].tahun_ajaran+'</option>');
