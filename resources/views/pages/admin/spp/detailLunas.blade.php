                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        ...
                                        @role("Admin")
                                        <form action="{{ url('admin/spp/kelas/'.$kelas_id.'/filterLunas') }}" method="POST" enctype="multipart/form-data">
                                            @endrole
                                            @role("Bendahara")
                                            <form action="{{ url('bendahara/spp/kelas/'.$kelas_id.'/filterLunas') }}" method="POST" enctype="multipart/form-data">
                                        @endrole
                                            @csrf
