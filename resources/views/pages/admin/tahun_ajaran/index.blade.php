...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Data {{ $title }}</div>
            <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('tahunajaran.update') }}" enctype="multipart/form-data">
                                            <input type="hidden" name="tahunajaran_id" value="{{ $key->id }}">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="tahun_ajaran" placeholder="Masukkan Tahun Ajaran. ex: 2020/2021">
                                             </div>
                                             <div class="form-group">
